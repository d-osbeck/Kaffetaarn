...
<main class="bestilling container-fluid bg-danger py-5">
    <div class="bestilling__card bg-dark py-5 px-3 container rounded-2 text-white p-lg-5 h-100">
        <section class="bestilling__content">
            ...
            <form class="bestilling__formular my-4">
                ...
                <div class="bestilling__form__item mb-4">
                ...
                <a href=""><button class="bg-primary text-black font-weight-500 rounded py-2 px-4 mx-1 border-0 py-xl-3 px-xl-5 mx-xl-3">BESTIL</button></a>
            </form>
        </section>
    </div>
</main>
